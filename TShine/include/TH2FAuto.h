...
public:
  ...
  void Reset();
  void ResetBuffer();
  void SetAutoRangeNumOfBins(int,int);
...
private:
  ...
  std::vector<double> fBufferX;
  std::vector<double> fBufferY;
  std::vector<double> fBufferXOut;
  std::vector<double> fBufferYOut;
  

  double fBufferXMinMax[2];
  double fBufferYMinMax[2];
